...
// SearchBar
#define COCOAPODS_POD_AVAILABLE_SearchBar
#define COCOAPODS_VERSION_MAJOR_SearchBar 0
#define COCOAPODS_VERSION_MINOR_SearchBar 0
#define COCOAPODS_VERSION_PATCH_SearchBar 1
